...
<div class="card bg-base-100 border mt-2">
    <div class="card-body">
        <form action="<?= base_url('dashboard/dosen/create') ?>" method="post" enctype="multipart/form-data">
            <div class="grid grid-cols-12 grid-flow-row gap-6">
                <div class="col-span-12 sm:col-span-6 md:col-span-4 form-control">
                    <label class="label">
                        <span class="label-text">NIP</span>
                    </label>
                    <input type="number" name="nip" class="input input-bordered" required />
                </div>
                <div class="col-span-12 sm:col-span-6 md:col-span-4 form-control">
                    <label class="label">
                ...
                <div class="col-span-12 sm:col-span-6 md:col-span-4 form-control">
                    ...
                    <input type="number" name="telepon" class="input input-bordered" required />
                </div>
                <div class="col-span-12 form-control">
                    <label class="label">
                        <span class="label-text">Alamat</span>
                    </label>
                    <textarea name="alamat" id="alamat" rows="5" class="textarea textarea-bordered" require></textarea>
                </div>
