...
<div class="card bg-base-100 border mt-2">
    <div class="card-body">
        <form action="<?= base_url('dashboard/mahasiswa/update/' . $data->id) ?>" method="post" enctype="multipart/form-data">
            <div class="grid grid-cols-12 grid-flow-row gap-6">
                ...
                <div class="col-span-12 sm:col-span-6 md:col-span-4 form-control">
                    ...
                    <input type="text" name="nim" value="<?= $data->nim ?>" class="input input-bordered" required />
                </div>
                <div class="col-span-12 sm:col-span-6 md:col-span-4 form-control">
                    <label class="label">
